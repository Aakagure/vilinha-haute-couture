...
public class HorizontalFacingBlock_ConnectVertical_ShapeVSlab extends HorizontalFacingBlock_ConnectVertical {
    public HorizontalFacingBlock_ConnectVertical_ShapeVSlab(Settings settings) {
        super(settings);
    }
