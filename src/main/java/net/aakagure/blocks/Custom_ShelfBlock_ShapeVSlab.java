...
public class Custom_ShelfBlock_ShapeVSlab extends Custom_ShelfBlock {
    public Custom_ShelfBlock_ShapeVSlab(Settings settings) {
        super(settings);
    }

    @Override
    public VoxelShape getOutlineShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context) {
        // Retorna a forma correta baseada na rotação
