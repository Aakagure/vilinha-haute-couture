...
public class HorizontalFacingBlock_ConnectUDLR_ShapeVSlab extends HorizontalFacingBlock_ConnectUDLR {
    public HorizontalFacingBlock_ConnectUDLR_ShapeVSlab(Settings settings) {
        super(settings);
    }
