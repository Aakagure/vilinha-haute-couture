...
public class HorizontalFacingBlock_ConnectUDLR_ActionLit_ShapeVSlab extends HorizontalFacingBlock_ConnectUDLR_ShapeVSlab {
    public static final BooleanProperty LIT = Properties.LIT;

    public HorizontalFacingBlock_ConnectUDLR_ActionLit_ShapeVSlab(Settings settings) {
        super(settings);
