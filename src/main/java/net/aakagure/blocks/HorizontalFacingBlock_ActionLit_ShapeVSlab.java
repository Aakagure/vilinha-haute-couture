...
public class HorizontalFacingBlock_ActionLit_ShapeVSlab extends HorizontalFacingBlock_ActionLit {
    public HorizontalFacingBlock_ActionLit_ShapeVSlab(Settings settings) {
        super(settings);
    }
