...
public class HorizontalFacingBlock_OnHalf_ShapeVSlab extends HorizontalFacingBlock_OnHalf_ShapeSlim {
    public HorizontalFacingBlock_OnHalf_ShapeVSlab(Settings settings) {
        super(settings);
    }
