...
public class HorizontalFacingBlock_ActionClick_ShapeVSlab extends HorizontalFacingBlock_ActionClick {
    public HorizontalFacingBlock_ActionClick_ShapeVSlab(Settings settings) {
        super(settings);
    }
